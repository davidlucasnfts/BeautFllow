...
- [ ] Rodar migration 006-remove-client-cpf-email.sql no Supabase (SQL Editor) — remove CPF e e-mail do cadastro de cliente. O app já funciona sem esses campos antes da migration; ela só apaga as colunas
